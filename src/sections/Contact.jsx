    ...
    >
      <div className="max-w-5xl mx-auto text-center space-y-4">
        ...
        <p className="text-slate-300 max-w-3xl mx-auto text-sm md:text-base">
          Whether you’re ready to train, collaborate, or just need answers about
          programming, drop a line. Our coaches respond fast because momentum is
          built in the follow-through.
        </p>
      </div>
