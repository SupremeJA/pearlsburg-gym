      ...
      <div className="max-w-6xl">
        ...
        <div className="relative z-10 max-w-4xl space-y-8">
          ...
          <p className="hero-copy text-slate-200 text-base md:text-lg max-w-3xl">
            Dominate every session with tailored coaching, premium equipment,
            and a community that keeps you accountable. We build strength,
            resilience, and momentum for the long haul.
          </p>
